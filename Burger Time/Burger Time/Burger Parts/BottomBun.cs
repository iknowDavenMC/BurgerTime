...
{
    public class BottomBun : BurgerPart
    {
        #region Constrcutors
        ...
        public BottomBun(Vector2 position, float x, float y)
            : base(position, x, y)
        {
            artist = new DrawingComponent(SpriteDatabase.GetAnimation("Bottom Bun Bounce"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);

            artists = new DrawingComponent[4];
            artists[0] = new DrawingComponent(SpriteDatabase.GetAnimation("Bottom Bun Left"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);
            artists[1] = new DrawingComponent(SpriteDatabase.GetAnimation("Bottom Bun Middle Left"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);
            artists[2] = new DrawingComponent(SpriteDatabase.GetAnimation("Bottom Bun Middle Right"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);
            artists[3] = new DrawingComponent(SpriteDatabase.GetAnimation("Bottom Bun Right"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);
        }
