...
{
    public class Cheese : BurgerPart
    {
        #region Constrcutors
        ...
        public Cheese(Vector2 position, float x, float y)
            : base(position, x, y)
        {
            artist = new DrawingComponent(SpriteDatabase.GetAnimation("Cheese Bounce"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);

            artists = new DrawingComponent[4];
            artists[0] = new DrawingComponent(SpriteDatabase.GetAnimation("Cheese Left"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);
            artists[1] = new DrawingComponent(SpriteDatabase.GetAnimation("Cheese Middle Left"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);
            artists[2] = new DrawingComponent(SpriteDatabase.GetAnimation("Cheese Middle Right"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);
            artists[3] = new DrawingComponent(SpriteDatabase.GetAnimation("Cheese Right"), Color.White,
                new Vector2(SettingsManager.GetInstance().Scale, SettingsManager.GetInstance().Scale), 1);
        }
