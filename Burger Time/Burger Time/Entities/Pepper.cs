...
namespace Burger_Time
{
    public class Pepper : PowerUp
    {
        ...
        public Pepper(Vector2 position, float x, float y, int points, int lifeTime)
            : base(position, x, y, points, lifeTime)
        {
            artist = new DrawingComponent(SpriteDatabase.GetAnimation("Pepper"), Color.White,
