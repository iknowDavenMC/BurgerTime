...
{
    public class FrenchFries : PowerUp
    {
        #region Constructors
        ...
        public FrenchFries(Vector2 position, float x, float y, int points, int lifeTime)
            : base(position, x, y, points, lifeTime)
        {
            artist = new DrawingComponent(SpriteDatabase.GetAnimation("French Fries"), Color.White,
